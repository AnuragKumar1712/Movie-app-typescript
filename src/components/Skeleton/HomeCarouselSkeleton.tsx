    ...
    <div>
        ...
        <div className="absolute bottom-0 md:flex items-end gap-4 px-4 w-full">
            ...
            <div className="flex flex-col gap-1 w-full">
                ...
                <h2 className="lg:text-xl md:text-lg text-md w-[45%] placeholder"></h2>
                <div className="flex items-center gap-1 lg:text-xl md:text-md text-sm w-[30%] placeholder"></div>
            </div>
        </div>
    </div>
  )
